...
A continuación, en la Figura [referencia](#fig-valor-en-peones-asociados-a-cada-pieza), se muestra el valor asignado a cada pieza. Por supuesto, el valor de una pieza depende de su posición específica en el tablero, pero estas estimaciones suelen ser buenas aproximaciones en la mayoría de las situaciones.
...
A continuación, se ilustra la aplicación de esta heurística con una posición específica, que se muestra en la Figura [referencia](#fig-posicion-de-ejemplo-para-calcular-la-heuristica).
